namespace FestivalManager.Entities
{
	...
	private readonly List<Performer> performers;
        ...
        public string AddSongToPerformer(string songName, string performerName)
        {
            ...
            Performer perfomer = this.GetPerformer(performerName);
        ...
        public string Play()
        {
            int songsCount = this.performers.Sum(p => p.SongList.Count());
        ...
        {
            Performer performer = this.Performers.FirstOrDefault(p => p.FullName == performerName);
            if (performer == null)
            {
        ...
        {
            Song song = this.Songs.FirstOrDefault(p => p.Name == songName);
            if (song == null)
            {
