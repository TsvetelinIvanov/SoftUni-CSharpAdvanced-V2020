...
namespace Heroes
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(heroStrength.Name);// Hero with name Second Hero
            Hero heroAbility = repository.GetHeroWithHighestAbility();
            Console.WriteLine(heroAbility.Name);// Hero with name Hero Name
            Hero heroIntelligence = repository.GetHeroWithHighestIntelligence();
            Console.WriteLine(heroIntelligence.Name);// Hero with name Hero Name
