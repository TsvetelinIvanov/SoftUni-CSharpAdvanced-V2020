...
namespace CustomDoublyLinkedList//For Judge have to change the name of .csproj fail (in the zip) to CustomDoublyLinkedList but it doesn't past - compile time error because there are no tests!!!
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(string.Join(" ", customLinkedList));//8 7 6 5 4 3 2 1 0
